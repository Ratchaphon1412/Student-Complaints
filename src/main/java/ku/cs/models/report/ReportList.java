                ...
                if(pattern.get("category").equals(reportKey.get("category"))){
                  for(LinkedHashMap<String,String> like: likePostList){
                     if(like.get("title").equals(reportKey.get("title"))){
                         Report report = new Report(userList.getUser(reportKey.get("user")),reportKey.get("title"),new Category(reportKey.get("category"),reportKey.get("text"),reportKey.get("image"),pattern.get("text"), pattern.get("image")),reportKey.get("reportStage"),reportKey.get("problemDate"),reportKey.get("time"),like.get("like"),like.get("userName"));
